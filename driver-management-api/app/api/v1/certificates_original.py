...
from app.crud import (
    get_certificates as crud_get_certificates, get_certificate_by_id as crud_get_certificate_by_id,
    create_certificate as crud_create_certificate, update_certificate as crud_update_certificate,
    delete_certificate as crud_delete_certificate,
    get_driver_by_id,
...
async def get_certificates(
    ...
    """获取证书列表"""
    try:
        certificates = await crud_get_certificates(
            db=db,
            skip=skip,
            limit=limit,
            driver_id=driver_id,
